...
public class UMovie {
    ...
    private boolean verificarOpcionConsultas(int opcion){
        switch (opcion) {
            ...
            case 5 -> TopActorPorMes.realizarConsultav3(peliculas, actores); //TopActorPorMes.realizarConsulta(peliculas, actores); //System.out.println("Funcion de actor mejor calificado por cada mes (Pendiente)");
